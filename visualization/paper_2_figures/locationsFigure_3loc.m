...
set(gca,'FontSize',fs)
ax(9).TickLabelInterpreter = 'latex';
...
% % 
print(datacomp,['~/Dropbox (MREL)/Research/OO-TechEc/' ...
    'wave-comparison/paper_figures/locations'],  ...
    '-dpng','-r600')
