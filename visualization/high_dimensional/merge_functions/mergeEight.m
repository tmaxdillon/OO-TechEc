function [allStruct] = mergeEight(struct1,struct2,struct3, ... 
    struct4,struct5,struct6,struct7,struct8)

% inputs (inau, inhu, wiod, wico, dies, wodu, woco, wcons)
...
%merge wind optimistic durability
for i = 1:size(allStruct,1)
    for j = 1:size(allStruct,3)
